...
public final class FragmentSlideshowBinding implements ViewBinding {
  ...
  private FragmentSlideshowBinding(@NonNull ConstraintLayout rootView, @NonNull PieChart piechart) {
  ...
  public static FragmentSlideshowBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSlideshowBinding((ConstraintLayout) rootView, piechart);
    }
